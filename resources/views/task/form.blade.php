...
<div class="flex flex-col">
    ...
    <div class="mt-2">
        <input type="text" name="name" id="name" class="rounded border-gray-300 w-1/3 text-gray-800 bg-white" value="{{ old('name', $task->name ?? '') }}">
    </div>
    ...
    <div class="mt-2">
        <textarea name="description" id="description" class="rounded border-gray-300 w-1/3 h-32 text-gray-800 bg-white" cols="50" rows="10">{{ old('description', $task->description ?? '') }}</textarea>
    </div>
    ...
    <div class="mt-2">
        <select name="status_id" id="status_id" class="rounded border-gray-300 w-1/3 text-gray-800 bg-white">
            <option value="">----------</option>
    ...
    <div class="mt-2">
        <select name="assigned_to_id" id="assigned_to_id" class="rounded border-gray-300 w-1/3 text-gray-800 bg-white">
            <option value="">----------</option>
    ...
    <div class="mt-2">
        <select name="labels[]" id="labels" class="rounded border-gray-300 w-1/3 h-32 text-gray-800 bg-white" multiple>
